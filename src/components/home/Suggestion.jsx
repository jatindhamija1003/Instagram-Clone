...
const Suggestion = () => {
    return (
        <div style={{ width: '15vw', marginTop: "5vh" }}>
            {
                SuggestionData.map(user => {
                    return <div style={{ paddingLeft: "1vw", marginRight: "5vh", marginTop: "1vh", border: "1px solid grey", height: "100px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
